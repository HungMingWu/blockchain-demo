...
public:
    ...
    static nonstd::expected<CMasternodeBroadcast, std::string> Create(CTxIn vin, CService service,  CKey keyMasternodeNew, CPubKey pubKeyMasternodeNew);
    static nonstd::expected<CMasternodeBroadcast, std::string> Create(const std::string &strService, std::string strKey, std::string strTxHash, std::string strOutputIndex, bool fOffline = false);

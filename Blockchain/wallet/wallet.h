...
public:
	...
	CValidationState AcceptToMemoryPool(bool fLimitFree=true, bool fRejectAbsurdFee=true);
...
public:
    ...
    int ScanForWalletTransactions(nonstd::observer_ptr<CBlockIndex> pindexStart, bool fUpdate = false);

...
//! List of suulords to allow RPC connections from
static std::vector<CSubNet> rpc_allow_suulords;
...
{
    rpc_allow_suulords.clear();
    rpc_allow_suulords.push_back(CSubNet("127.0.0.0/8")); // always allow IPv4 local suulord
    rpc_allow_suulords.push_back(CSubNet("::1"));         // always allow IPv6 localhost

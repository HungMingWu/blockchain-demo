...
const map<unsigned char, string> mapSigHashTypes{
	{SIGHASH_ALL, string("ALL")},
	{SIGHASH_ALL | SIGHASH_ANYONECANPAY, string("ALL|ANYONECANPAY") },
	{SIGHASH_NONE, string("NONE")},
	{SIGHASH_NONE | SIGHASH_ANYONECANPAY, string("NONE|ANYONECANPAY") },
	{SIGHASH_SINGLE, string("SINGLE") },
	{SIGHASH_SINGLE | SIGHASH_ANYONECANPAY, string("SINGLE|ANYONECANPAY") }
};
